...
* **set_scene()** a convenience wrapper to rgl scene settings, it makes the scene look "straight-down" 
 and locks pan and tilt so the rgl device like a zoom-in/zoom-out 2D displaye
* **break_mesh()** break the topology of a mesh (so that primitives can be free-floating, not
 tied to their neighbour's vertices)


See [design vignette](https://github.com/hypertidy/textures/blob/master/vignettes/design.Rmd). 
