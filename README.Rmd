...
* **set_scene()** a convenience wrapper to rgl scene settings, it makes the scene look "straight-down"  and locks pan and tilt so the rgl device like a zoom-in/zoom-out 2D displaye
